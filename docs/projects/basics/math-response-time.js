...
let start2 = Date.now();
let response2 = prompt('What is ' + (Math.floor(Math.random() * 10) + 1) + ' + ' + (Math.floor(Math.random() * 10) + 1) + ' ? ');
let end2 = Date.now();
let responseTime2 = (end2 - start2) / 1000;
alert('You answered:' + response2 + ' in ' + responseTime2 + ' seconds ');
let start3 = Date.now();
let response3 = prompt('What is ' + (Math.floor(Math.random() * 10) + 1) + ' + ' + (Math.floor(Math.random() * 10) + 1) + ' ? ');
let end3 = Date.now();
